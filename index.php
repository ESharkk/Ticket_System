...
<div class="content home">
	...
	<p> You can view the list of tickets below.</p>
	...
	<div class="tickets-list">
		...
		<a href="view.php?id=<?=$ticket['id']?>" class="ticket">
			...
			<span class="con">
				<span class="email" style="Times New Roman; font-size: 10px; color: #0000FF;" ><?=htmlspecialchars($ticket['email'], ENT_QUOTES)?></span>
